...
import com.example.flema.service.CategoryService;
...
public class ItemController {
  ...
  public String showItemDetail(
    ...
    // 出品者の平均評価があれば 1桁小数で埋め込む
    reviewService.getAverageRatingForSeller(foundItem.getSeller())
        .ifPresent(avg -> model.addAttribute(
            "sellerAverageRating",
